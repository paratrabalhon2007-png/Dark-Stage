          ...
          <div class="space-y-6">
            ...
            <div class="space-y-2">
               <a href="https://youtu.be/7B_1ATnnmww" target="_blank" rel="noopener noreferrer" class="block w-full">
                <div class="my-4 p-6 bg-white/5 border border-white/10 rounded-xl text-center font-bold tracking-[0.2em] uppercase text-white shadow-inner hover:bg-white/10 hover:border-red-500/50 transition-all group">
            ...
            <div class="space-y-2">
              ...
              <a href="https://miro.com/app/board/uXjVLSWuwQM=/" target="_blank" rel="noopener noreferrer" class="group block p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 hover:bg-blue-500/10 transition-all">
                <span class="font-bold">[ CLICK AQUI PARA VIZUALIZAR NOSSA ESTRUTURA BASE ]</span>
                <p class="text-xs text-blue-500/60 mt-1 opacity-100 transition-opacity italic">Clique para abrir o quadro no Miro</p>
              </a>
            </div>
            ...
            <button data-navigate-module="perfil-zero" class="w-full my-8 p-6 bg-white/5 border border-white/10 rounded-xl text-center font-bold tracking-[0.2em] uppercase text-white hover:bg-white/10 hover:border-blue-500/50 transition-all active:scale-[0.98] shadow-lg">
            ...
            <div class="pt-8">
              ...
              <div class="max-w-[320px] mx-auto bg-[#111] rounded-2xl border border-white/10 overflow-hidden shadow-2xl group hover:border-blue-500/30 transition-all">
      ...
      { 
        ...
        content: `
          <div class="space-y-6">
            ...
            <div class="my-6 p-4 bg-blue-500/10 border-l-4 border-blue-500 text-blue-200 text-xs font-bold uppercase tracking-widest">
        ...
        content: `
          <div class="space-y-8">
            ...
            <section class="space-y-4">
              ...
              <p class="text-white font-bold text-sm bg-white/5 p-3 rounded-lg border-l-2 border-blue-500">
            ...
            <section class="space-y-4">
              ...
              <div class="space-y-3">
                <div class="p-4 bg-[#1a1a1a] rounded-xl border border-white/5">
                  <p class="text-xs font-bold text-blue-400 uppercase tracking-widest mb-1">Nome de Usuário:</p>
                ...
                <div class="p-4 bg-[#1a1a1a] rounded-xl border border-white/5">
                  <p class="text-xs font-bold text-blue-400 uppercase tracking-widest mb-1">Nome da Conta:</p>
                  <p class="text-gray-300 text-sm">É o nome visível no topo do perfil. Pode ser personalizado com texto, emojis e não precisa ser único.</p>
                </div>
              </div>

              <p class="text-gray-300 text-sm leading-relaxed pt-4">
                Agora que você entendeu a diferença entre um nome de usuário e the nome da conta, é hora de otimizar seu nome para obter o máximo de alcance.
              </p>
              ...
              <p class="text-blue-200 text-xs font-bold italic bg-blue-500/5 p-3 rounded-lg border border-blue-500/20">
            ...
            <section class="space-y-4">
              ...
              <div class="space-y-3">
                ...
                <ul class="space-y-2 text-white font-bold text-sm ml-4">
                  <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> O QUE VOCÊ É</li>
                  <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> O QUE VOCÊ FAZ</li>
                  <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> INFORMAÇÃO ADICIONAL OU CTA</li>
                </ul>
              </div>
            </section>
            ...
            <div class="mt-12 p-8 bg-blue-500/5 border border-blue-500/20 rounded-2xl">
        ...
        content: `
          <div class="space-y-8">
            ...
            <section class="space-y-4">
              ...
              <p class="text-white font-black text-sm uppercase tracking-widest bg-blue-500/10 p-4 rounded-xl border border-blue-500/20">
            ...
            <section class="space-y-4">
              ...
              <div class="p-6 bg-white/5 border border-white/10 rounded-2xl">
                <p class="text-white font-bold text-sm mb-4">Eu uso a <span class="text-blue-400">Unbounded</span> e <span class="text-blue-400">Montserrat</span>.</p>
                <div class="space-y-2">
                  ...
                  <ul class="grid grid-cols-2 gap-2 text-white font-bold text-sm italic">
                    <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> Unbounded</li>
                    <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> Montserrat</li>
                    <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> Reveltica</li>
                    <li class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> Inter</li>
                  </ul>
                </div>
              </div>
            </section>
        ...
        content: `
          <div class="space-y-8">
            ...
            <section class="space-y-4 pt-6">
              ...
              <div class="space-y-2">
                <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">LINK:</p>
                <a href="https://miro.com/app/board/uXjVL91drmc=/" target="_blank" rel="noopener noreferrer" class="block p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 font-bold hover:bg-blue-500/10 transition-all text-sm uppercase tracking-wide">
          ...
          <div class="space-y-8">
            ...
            <section class="space-y-4">
              ...
              <div class="space-y-3 pt-2">
                ...
                <a href="https://www.notion.so/Lista-de-refer-ncias-1563f99da39280488350d1f24c55086e?source=copy_link" target="_blank" rel="noopener noreferrer" class="block p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 font-bold hover:bg-blue-500/10 transition-all text-sm uppercase tracking-wide">
            ...
            <section class="space-y-10 pt-16 border-t border-white/5">
              ...
              <div class="space-y-6">
                <div class="space-y-3">
                  <h4 class="text-lg font-black text-white uppercase flex items-center gap-2">
                    <span class="text-blue-500">1.</span> GANCHO (HOOK)
                  </h4>
                  <p class="text-gray-400 text-sm leading-relaxed">
                ...
                <div class="space-y-3">
                  <h4 class="text-lg font-black text-white uppercase flex items-center gap-2">
                    <span class="text-blue-500">2.</span> VALOR (A BASE)
                  </h4>
                  <p class="text-gray-400 text-sm leading-relaxed">
                ...
                <div class="space-y-3">
                  <h4 class="text-lg font-black text-white uppercase flex items-center gap-2">
                    <span class="text-blue-500">3.</span> CTA (CALL TO ACTION)
                  </h4>
                  <p class="text-gray-400 text-sm leading-relaxed">
              ...
              <div class="p-8 bg-blue-500/5 border border-blue-500/20 rounded-2xl text-center space-y-4">
          ...
          <div class="space-y-8">
            ...
            <section class="space-y-4 pt-4">
              <div class="space-y-2">
                ...
                <a href="https://outrageous-antler-30c.notion.site/CAPTURA-DE-CONTE-DO-13e3f99da39281299b36c3bb53030398?source=copy_link" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 font-bold hover:bg-blue-500/10 transition-all text-sm">
          ...
          <div class="space-y-8">
            ...
            <section class="space-y-4 pt-4">
              <div class="space-y-2">
                ...
                <a href="https://outrageous-antler-30c.notion.site/Meu-Guia-Gratuito-11d3f99da39280eb92aad12479d20aaa?source=copy_link" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3 p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 font-bold hover:bg-blue-500/10 transition-all text-sm">
        ...
        content: `
          <div class="space-y-8">
            <div class="space-y-4">
              ...
              <p class="text-gray-400 text-sm leading-relaxed">
                Aqui, eu vou te mostrar the <strong class="text-blue-400">Lead Magnet</strong> que uso dentro da <strong class="text-white">Kirvano</strong> e por que ele funciona como uma armadilha estratégica pra capturar atenção, gerar desejo e converter curiosos em compradores <strong class="text-white">mesmo em perfis pequenos.</strong>
              </p>
            </div>

            <section class="p-6 bg-[#111] border border-white/5 rounded-2xl space-y-4">
              <h4 class="text-white font-black uppercase tracking-tight italic">Mas afinal como criar um guia grátis mentor ?</h4>
              <p class="text-gray-400 text-sm leading-relaxed">
                Vá em no módulo chamado <button data-navigate-module="metodo" class="text-white font-black uppercase underline hover:text-blue-400 transition-colors">“MÉTODO”</button> acesse the livro e vá até a página do capítulo 5. Lá, eu ensino como de fato montar um guia gratuito.
              </p>
            </section>
            ...
            <section class="space-y-6 pt-4">
              ...
              <div class="space-y-3">
                ...
                <div class="p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl flex items-start gap-3">
                  ...
                  <p class="text-[10px] text-blue-300/80 font-bold uppercase tracking-widest leading-relaxed">
          ...
          <div class="space-y-8">
            ...
            <section class="space-y-4 p-6 bg-[#111] border border-white/5 rounded-2xl">
              ...
              <ol class="space-y-3 text-gray-400 text-sm">
                <li class="flex gap-3"><span class="text-blue-500 font-bold">1.</span> Abra the link do template.</li>
                <li class="flex gap-3"><span class="text-blue-500 font-bold">2.</span> Acima no canto superior direito, clique em "duplicar" para criar uma versão para você.</li>
                <li class="flex gap-3"><span class="text-blue-500 font-bold">3.</span> Agora basta editar e adaptar au seu tipo de conteúdo/nicho.</li>
                <li class="flex gap-3"><span class="text-blue-500 font-bold">4.</span> Após finalizar the seu guia gratuito, clique acima em "COMPARTILHAR".</li>
                <li class="flex gap-3"><span class="text-blue-500 font-bold">5.</span> Depois selecione a opção "PUBLICAR" e "PUBLICAR SITE".</li>
                <li class="flex gap-3"><span class="text-blue-500 font-bold">6.</span> Dessa forma, você terá acesso au link do seu template no formato de site para entregar aos seus clientes.</li>
              </ol>
            </section>
            ...
            <section class="space-y-6 pt-10 border-t border-white/5">
              <div class="space-y-3">
                ...
                <a href="https://youtu.be/TV6PPvPb31I?si=dwa-k1_Mya-4Pf7j" target="_blank" rel="noopener noreferrer" class="block p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 font-bold hover:bg-blue-500/10 transition-all text-sm uppercase tracking-wide text-center">
              ...
              <div class="space-y-3">
                ...
                <a href="https://youtu.be/xzea0oQiyk4?feature=shared" target="_blank" rel="noopener noreferrer" class="block p-4 bg-blue-500/5 border border-blue-500/20 rounded-xl text-blue-400 font-bold hover:bg-blue-500/10 transition-all text-sm uppercase tracking-wide text-center">
        ...
        content: `
          <div class="space-y-8">
            ...
            <div class="grid gap-4">
              <div class="p-6 bg-[#111] border border-white/5 rounded-2xl hover:border-blue-500/30 transition-all">
